# 입력 받기
# 초기 자본금 입력
capital = int(input("초기 자본금으 입력하세요: "))
# 주식 구매 가격 입력
purchase_price = int(input("주식 가격을 입력하세요: "))
# 주식 수 입력
number_of_shares = int(input("구매할 주식의 수을 입력하세요: "))
# (판매) 주식 가격 입력
amount_of_sales = int(input("판매할 때의 주식 가격을 입력하세요: "))
